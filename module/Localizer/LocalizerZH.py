...
class LocalizerZH():
    ...
    project_page_import_epub_title: str = "导入 EPUB 文件"
    project_page_import_epub_content: str = "选择一个 EPUB 文件，将其复制到输入文件夹中"
    project_page_import_epub_button: str = "选择文件"
    project_page_import_epub_filter: str = "EPUB 文件 (*.epub)"
    project_page_import_epub_success: str = "已成功导入 EPUB 文件"
