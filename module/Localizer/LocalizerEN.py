...
class LocalizerEN(LocalizerZH):
    ...
    project_page_import_epub_title: str = "Import EPUB File"
    project_page_import_epub_content: str = "Select an EPUB file to copy it into the input folder"
    project_page_import_epub_button: str = "Select File"
    project_page_import_epub_filter: str = "EPUB Files (*.epub)"
    project_page_import_epub_success: str = "EPUB file imported successfully"
